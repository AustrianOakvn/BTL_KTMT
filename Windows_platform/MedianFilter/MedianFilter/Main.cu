...
int main()
{
	...
	resultImageCPU->Save("D:\\Cppdev\\MedianFilter\\Lenna_cpu.bmp");
	resultImageGPU->Save("D:\\Cppdev\\MedianFilter\\Lenna_gpu.bmp");
	resultImageSharedGPU->Save("D:\\Cppdev\\MedianFilter\\Lenna_shared.bmp");
}